    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-10 md:space-y-14 font-sans font-light text-base md:text-[22px] leading-[1.9] text-royal-purple/80 ">
            ...
            <motion.p
              ...
              className="relative text-justify font-light font-sans"
            >
            ...
            >
              ...
              of{" "}
              <strong className="text-royal-purple font-sans font-medium text-justify">
