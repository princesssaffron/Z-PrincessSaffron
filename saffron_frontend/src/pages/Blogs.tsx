...
const saffronBenefits = [
  {
    ...
    subtitle: "Nature's Golden Medicine",
    image: saffronHealth,
    icon: Heart,
    benefits: [
      'Powerful antioxidant properties that fight free radicals',
      'May help improve mood and treat depression symptoms',
  ...
  },
  {
    ...
    image: saffronCulinary,
    icon: ChefHat,
    benefits: [
      'Biryani & Rice dishes for rich golden color',
      'Paella and Mediterranean cuisines',
      'Desserts like Kheer, Ice cream & Pastries',
      'Saffron milk and traditional beverages',
      'Marinades and gourmet sauces'
    ],
        ...
        <section className="bg-royal-purple-dark text-ivory py-20">
          <div className="container mx-auto px-6">
            ...
            >
              <br />
              <br />
              <h1 className="font-serif text-4xl md:text-5xl mb-4">Saffron Insights</h1>
              <br />
              ...
              {saffronBenefits.map((benefit, index) => (
                ...
                >
                  ...
                  <div className="relative h-full flex flex-col justify-end p-6 text-ivory">
                    ...
                    {/* Benefits List - Hidden by default, shown on hover */}
                    ...
                    {/* Hover indicator */}
                    <div className="absolute bottom-6 right-6 opacity-60 group-hover:opacity-0 transition-opacity">
                      <div className="w-8 h-8 border border-ivory/40 rounded-full flex items-center justify-center">
              ...
              {showForm && (
                ...
                >
                  <div className="bg-white rounded-2xl p-8 shadow-lg border border-charcoal/10">
                    <h3 className="font-serif text-2xl text-charcoal mb-6">Share Your Knowledge</h3>
                    <form onSubmit={handleSubmit} className="space-y-5">
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          placeholder="Write your article about saffron benefits, uses, recipes..."
                          maxLength={10000}
                        />
                      </div>
                      ...
                      <div className="flex gap-4 pt-2">
                        <button
                          ...
                          className="flex-1 inline-flex items-center justify-center px-6 py-2.5 border border-charcoal/30 text-charcoal font-medium text-sm rounded-full transition-all duration-300 hover:bg-charcoal/5 hover:scale-[1.02]"
>
                          Cancel
                        </button>
                        <button
                          ...
                          className="flex-1 inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-[#E6C76A] text-royal-purple-dark font-medium text-sm tracking-wide rounded-full transition-all duration-300 hover:shadow-gold-glow hover:scale-105 disabled:opacity-60"
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 pb-16">
                {blogs.map((blog, index) => (
                  ...
                  >
                    ...
                    <div className="p-6">
                      <h3 className="font-serif text-xl text-charcoal mb-3 group-hover:text-royal-purple transition-colors line-clamp-2">
                        {blog.title}
                      </h3>
                      <p className="text-charcoal/60 text-sm mb-4 line-clamp-3">
                        {blog.content}
                      </p>
            ...
            <div className="max-w-2xl mx-auto text-center">
              ...
              <form className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                <input
                  type="email"
                  placeholder="Enter your email"
                  className="flex-1 px-5 py-3 rounded-full border border-charcoal/20 focus:outline-none focus:border-royal-purple"
                />
                <button
                  type="submit"
                  className="inline-flex items-center justify-center px-6 py-2.5 bg-[#E6C76A] text-royal-purple-dark font-medium text-sm tracking-wide rounded-full transition-all duration-300 hover:shadow-gold-glow hover:scale-105"
>
                  Subscribe
                </button>
              </form>
