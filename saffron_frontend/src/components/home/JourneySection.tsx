...
const JourneySection = () => {
  ...
  return (
    <section ref={containerRef} className="relative">
      {/* Sticky Header */}
      <div className="sticky top-0 h-screen flex items-center justify-center bg-gradient-hero z-10">
        <motion.div
      ...
      {steps.map((step, index) => {
        ...
        return (
          <section
            key={step.step}
            className={`sticky top-0 h-screen flex items-center bg-gradient-to-b ${bgGradients[index]}`}
