...
const TestimonialsSection = () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const formattedReviews = data.map((review: any) => ({
          ...
          avatar: review.reviewer_name.charAt(0).toUpperCase(),
          isDynamic: true,
        }));
  ...
  const allTestimonials = [...dynamicReviews, ...testimonials].slice(0, 6);
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          ...
          >
            <Button
              ...
              className="bg-gradient-to-r from-gold to-gold-light text-royal-purple font-semibold px-10 py-6 text-base shadow-lg hover:shadow-[0_0_30px_rgba(212,175,55,0.4)] transition-all duration-300"
            >
