...
const Blogs = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: error.message || "Failed to publish your article. Please try again.",
        variant: "destructive"
      });
    } finally {
      setSubmitting(false);
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-12">
              <button
                ...
                className="inline-flex items-center gap-2 bg-royal-purple text-ivory font-medium px-6 py-3 rounded-full hover:bg-royal-purple-dark transition-colors"
              >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                      ...
                      <div className="flex gap-4 pt-2">
                        <button
                          ...
                          className="flex-1 border border-charcoal/30 text-charcoal font-medium py-3 rounded-full hover:bg-charcoal/5 transition-colors"
                        >
                          Cancel
                        </button>
                        <button
                          ...
                          className="flex-1 bg-royal-purple text-ivory font-medium py-3 rounded-full hover:bg-royal-purple-dark transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                        >
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-2xl mx-auto text-center">
              ...
              >
                ...
                <button
                  type="submit"
                  className="px-8 py-3 bg-royal-purple text-ivory rounded-full font-medium hover:bg-royal-purple-dark transition-colors"
                >
                  Subscribe
                </button>
              </form>
