        ...
        <div className="grid gap-10 md:grid-cols-2">
          {features.map((feature, index) => (
            ...
            >
              ...
              {/* Interactive title */}
              <h3 className="relative inline-block font-serif font-medium text-[20px] md:text-[20px]  tracking-[0.1em] text-royal-purple leading-[1.4] mb-4 transition-colors duration-500 group-hover:text-gold">
  {feature.title}
  <span className="absolute left-0 -bottom-1 h-[1px] w-0 bg-gold transition-all duration-500 group-hover:w-full"></span>
</h3>

             <p className="font-sans font-medium text-[15px]  text-royal-purple/65 leading-[1.65] tracking-[0.01em]">
                {feature.description}
              </p>
            </motion.div>
          ))}
